        ...
        >
          ...
          <div class="col-span-2 flex items-center gap-3">
            ...
            <div class="text-center">
              ...
              <div class="text-sm font-semibold text-cyan-500">{{ (item.enter_battery / 100).toFixed(2) }}</div>
            </div>
          </div>
          ...
          <div class="col-span-2 flex items-center gap-3">
            ...
            <div class="text-center">
              <div class="text-xs text-(--ui-text-muted) mb-0.5">妖力</div>
              <div class="text-sm font-semibold text-pink-500">{{ (item.out_battery / 100).toFixed(2) }}</div>
            </div>
          </div>

...
import { baseColumns, type TableColumnList } from '@/components/common/modelPreset/columns'
...
<template>
  <DashboardLayout>
    ...
    <DynamicTable
      ref="tableRef"
      :data-request="getCommonModelPresetList"
      :columns="columns"
      scroll-x="min-w-[100px]"
    />
  </DashboardLayout>

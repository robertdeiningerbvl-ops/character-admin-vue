...
import { baseColumns, type TableColumnList } from '@/components/amusement/parameter/columns'
...
<template>
  <DashboardLayout>
    ...
    <DynamicTable
      ref="tableRef"
      :data-request="getAmusementParameterList"
      :columns="columns"
      scroll-x="min-w-[1000px]"
    />
  </DashboardLayout>
  <AmusementParameterEdit
